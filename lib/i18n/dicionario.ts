...
export const DICIONARIO: Traducoes = {
  ...
  "Estes recursos já usam o": { es: "Estos recursos ya usan" },
  ...
  "não está no catálogo de modelos desta instalação.": { es: "no está en el catálogo de modelos de esta instalación." },
  "O assistente do atendente agora usa o": { es: "El asistente del agente ahora usa" },
  ...
  "Usar nestes recursos:": { es: "Usar en estos recursos:" },
  // Assistente do atendente — resumo e prioridade da fila
  "A Fila agora mostra os urgentes primeiro.": { es: "La Cola ahora muestra primero los urgentes." },
  "A Fila voltou à ordem por tempo de espera.": { es: "La Cola volvió al orden por tiempo de espera." },
  "A IA já mede o clima de cada mensagem recebida. Com isto ligado, cliente com prazo, problema em andamento ou insatisfeito sobe na Fila e ganha o selo Urgente — para o time inteiro.": { es: "La IA ya mide el clima de cada mensaje recibido. Con esto activado, el cliente con plazo, problema en curso o insatisfecho sube en la Cola y recibe la etiqueta Urgente — para todo el equipo." },
  "A IA marcou esta conversa como urgente ou com cliente insatisfeito": { es: "La IA marcó esta conversación como urgente o con cliente insatisfecho" },
  "A IA não devolveu resumo. Tente de novo em instantes.": { es: "La IA no devolvió el resumen. Inténtalo de nuevo en unos instantes." },
  "Atualizar resumo": { es: "Actualizar resumen" },
  "Contato bloqueado ou anonimizado: o resumo não é gerado.": { es: "Contacto bloqueado o anonimizado: el resumen no se genera." },
  "Conversas passadas para uma pessoa chegam com resumo.": { es: "Las conversaciones pasadas a una persona llegan con resumen." },
  "Desatualizado": { es: "Desactualizado" },
  "Esta conversa ainda não tem mensagens para resumir.": { es: "Esta conversación aún no tiene mensajes para resumir." },
  "Gerado a pedido": { es: "Generado a pedido" },
  "Gerado quando a conversa passou para uma pessoa": { es: "Generado cuando la conversación pasó a una persona" },
  "Gerar resumo": { es: "Generar resumen" },
  "Muitos resumos seguidos. Tente em um minuto.": { es: "Demasiados resúmenes seguidos. Inténtalo en un minuto." },
  "Nenhum resumo ainda. A IA lê a conversa e diz o motivo, o que já foi feito, o que falta e o clima.": { es: "Aún no hay resumen. La IA lee la conversación e indica el motivo, lo que ya se hizo, lo que falta y el clima." },
  "Não foi possível carregar o resumo.": { es: "No se pudo cargar el resumen." },
  "Não foi possível gerar o resumo.": { es: "No se pudo generar el resumen." },
  "Não foi possível ler o histórico desta conversa.": { es: "No se pudo leer el historial de esta conversación." },
  "O modelo escolhido não existe no provedor. Confira em IA › Provedores.": { es: "El modelo elegido no existe en el proveedor. Revisa en IA › Proveedores." },
  ...
  "O provedor de IA recusou a chave. Confira em IA › Credenciais.": { es: "El proveedor de IA rechazó la clave. Revisa en IA › Credenciales." },
  "O provedor de IA recusou por limite de uso ou saldo. Tente mais tarde.": { es: "El proveedor de IA rechazó por límite de uso o saldo. Inténtalo más tarde." },
  "O resumo automático foi desligado. O botão continua disponível.": { es: "El resumen automático se desactivó. El botón sigue disponible." },
  "O teto mensal de gasto com IA foi atingido. Ajuste em Uso de IA › Orçamento.": { es: "Se alcanzó el tope mensual de gasto en IA. Ajusta en Uso de IA › Presupuesto." },
  "Pôr as conversas urgentes no topo da Fila": { es: "Poner las conversaciones urgentes al principio de la Cola" },
  "Quem assume vê no topo da conversa o motivo, o que já foi feito, o que falta e o clima. Uma chamada de IA por passagem; o botão \"Gerar resumo\" funciona com isto desligado.": { es: "Quien asume ve arriba de la conversación el motivo, lo que ya se hizo, lo que falta y el clima. Una llamada de IA por traspaso; el botón \"Generar resumen\" funciona con esto desactivado." },
